...
class JoystickController {
  ...
  init() {
    ...
    this.style.setAttribute("id", "style-" + this.id);
	  // transform: translate(${this.options.leftToRight ? "-50%" : "50%"}, ${this.options.bottomToUp ? "50%" : "-50%"});
    ...
    document.getElementById(this.options.dstDiv).appendChild(this.container);
  ...
  destroy() {
    ...
    document.getElementById(this.options.dstDiv).removeChild(this.container);
  }
}
// var _default = JoystickController;
