...
*
* PhB : Small modification to display current angle & other small changes since we do not control an airplane
*
*/
(function($) {
	function FlightIndicator( placeholder, type, options ) {
		...
		placeholder.each(function(){
			switch(type){
				case 'heading':
					$(this).html('<div class="instrument heading"><img src="' + settings.img_directory + 'fi_box.svg" class="background box" alt="" /><div class="heading box"><img src="' + settings.img_directory + 'heading_yaw.svg" class="box" alt="" /></div><div class="mechanics box"><img src="' + settings.img_directory + 'heading_mechanics.svg" class="box" alt="" /><img src="' + settings.img_directory + 'fi_circle.svg" class="box" alt="" /><div id="yaw" class="yawtxt"></div></div></div>');
				...
				break;
				default:
					$(this).html('<div class="instrument attitude"><img src="' + settings.img_directory + 'fi_box.svg" class="background box" alt="" /><div class="roll box"><img src="' + settings.img_directory + 'horizon_back.svg" class="box" alt="" /><div class="pitch box"><img src="' + settings.img_directory + 'horizon_ball.svg" class="box" alt="" /></div><img src="' + settings.img_directory + 'horizon_circle.svg" class="box" alt="" /></div><div class="mechanics box"><img src="' + settings.img_directory + 'horizon_mechanics.svg" class="box" alt="" /><img src="' + settings.img_directory + 'fi_circle.svg" class="box" alt="" /><div id="roll" class="rolltxt"></div><div id="pitch" class="pitchtxt"></div></div></div>');
		...
		function _setPitch(pitch){
			...
			placeholder.each(function(){
				if(pitch!=prevpitch) {
					...
					$(this).find("#pitch").html(npitch+'&deg;');
					prevpitch=npitch;
				}
			});
		}
		...
		function _setHeading(heading){
			placeholder.each(function(){
				...
				if(heading!=prevyaw) {
					...
					// $(this).find("#yaw").html(heading+'&deg;');
					prevyaw=heading;
				}
			});
		}
